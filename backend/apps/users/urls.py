...
from .admin_views import (
    ...
    admin_export_asaas_extract_json,
    admin_overdue_enrollments,
    admin_enrollments_list,
    admin_enrollment_update,
    admin_empires_board,
    admin_empires_allocate,
    admin_social_quotas_list,
    admin_social_quota_contribution_create,
    admin_social_quota_contribution_detail,
    admin_settings,
    admin_products_list,
    admin_batches_list,
    admin_coupons_list,
    ...
    admin_product_close_enrollment,
    admin_batch_create,
    admin_batch_update,
    admin_batch_delete,
    admin_waitlist_list,
    admin_waitlist_invite,
    admin_waitlist_delete,
    admin_waitlist_extend_deadline,
    admin_waitlist_reorder,
    admin_waitlist_toggle_auto_invite,
    admin_coupon_create,
    admin_coupon_update,
    admin_coupon_delete,
)
...
urlpatterns = [
    ...
    path('admin/dashboard/export-asaas-extract-json/', admin_export_asaas_extract_json, name='admin-export-asaas-extract-json'),
    ...
    path('admin/empires/', admin_empires_board, name='admin-empires-board'),
    path('admin/empires/allocate/', admin_empires_allocate, name='admin-empires-allocate'),
    path('admin/social-quotas/', admin_social_quotas_list, name='admin-social-quotas-list'),
    path('admin/social-quotas/contributions/', admin_social_quota_contribution_create, name='admin-social-quota-contribution-create'),
    path('admin/social-quotas/contributions/<int:pk>/', admin_social_quota_contribution_detail, name='admin-social-quota-contribution-detail'),
    ...
    path('admin/products/<int:pk>/close-enrollment/', admin_product_close_enrollment, name='admin-product-close-enrollment'),
    ...
    path('admin/waitlist/', admin_waitlist_list, name='admin-waitlist-list'),
    path('admin/waitlist/reorder/', admin_waitlist_reorder, name='admin-waitlist-reorder'),
    path('admin/waitlist/auto-invite/', admin_waitlist_toggle_auto_invite, name='admin-waitlist-auto-invite'),
    path('admin/waitlist/<int:pk>/invite/', admin_waitlist_invite, name='admin-waitlist-invite'),
    path('admin/waitlist/<int:pk>/extend-deadline/', admin_waitlist_extend_deadline, name='admin-waitlist-extend-deadline'),
    path('admin/waitlist/<int:pk>/delete/', admin_waitlist_delete, name='admin-waitlist-delete'),
